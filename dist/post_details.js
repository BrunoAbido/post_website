...
function renderPostDetails() {
    ...
    console.log(id);
    const filterPostById = posts.find((post) => post.id === parseInt(id, 10));
    const RenderDetails = document.querySelector(".post_section");
    const renderComents = document.querySelector(".review_section");
    const FilterComents = ComentUsers.find((post) => post.postId === (filterPostById === null || filterPostById === void 0 ? void 0 : filterPostById.id));
    ...
    if (renderComents) {
        FilterComents === null || FilterComents === void 0 ? void 0 : FilterComents.coments.map((coment) => {
            ...
            `;
            renderComents === null || renderComents === void 0 ? void 0 : renderComents.appendChild(listComent);
            renderComents === null || renderComents === void 0 ? void 0 : renderComents.appendChild(hr);
        });
    }
}
renderPostDetails();
